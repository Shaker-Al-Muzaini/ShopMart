                    ...
                    <div className="flex flex-col lg:flex-row">
                        ...
                        <div className="w-full p-6 lg:w-2/5">
                            <div className="relative mb-4">
                                ...
                                <img
                                    src={getSafeImageUrl(images[activeImage]?.large || images[activeImage]).replace('localhost', '127.0.0.1:8000')}
                                    alt={product.name}
                            ...
                            <div className="grid grid-cols-4 gap-2">
                                {images.map((image: any, index: number) => (
                                    ...
                                    >
                                        <img
                                            src={getSafeImageUrl(image?.thumb || image).replace('localhost', '127.0.0.1:8000')}
